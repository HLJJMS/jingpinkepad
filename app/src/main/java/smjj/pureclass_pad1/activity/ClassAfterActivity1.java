...
import smjj.pureclass_pad1.fragment.FeedbackFragment1;
import smjj.pureclass_pad1.fragment.SettingWorkFragment1;
import smjj.pureclass_pad1.fragment.StudentAnalysisFragment1;
import smjj.pureclass_pad1.fragment.TeachingReflectionFragment1;
...
//二期课后界面
public class ClassAfterActivity1 extends BaseActivity implements View.OnClickListener{
    ...
    private StudentAnalysisFragment1 studentAnalysisFragment1;
    private FeedbackFragment1 feedbackFragment1;
    private SettingWorkFragment1 settingWorkFragment1;
    private TeachingReflectionFragment1 teachingReflectionFragment1;
    ...
    public String selectType;//班课类型

    public String grade, subject;
    public String className, schoolName, materialName, stuName, classNo, materialNo, courseName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_class_after1);
    ...
    private void initFragment() {
        ...
        if (settingWorkFragment1 == null){
            settingWorkFragment1 = new SettingWorkFragment1();
        }
        ft.add(R.id.class_framelayout, settingWorkFragment1);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.rl_setting_work:
                ...
                showFragmentAtPosition1(settingWorkFragment1);
                openOrCloseDrawerLayout();
            ...
            case R.id.rl_teaching_reflection:
                ...
                if (teachingReflectionFragment1 == null){
                    teachingReflectionFragment1 = new TeachingReflectionFragment1();
                }
                showFragmentAtPosition1(teachingReflectionFragment1);
                openOrCloseDrawerLayout();
                break;
            case R.id.rl_feedback:
                ...
                if (feedbackFragment1 == null){
                    feedbackFragment1 = new FeedbackFragment1();
                }
                showFragmentAtPosition1(feedbackFragment1);
                openOrCloseDrawerLayout();
                break;
            case R.id.rl_student_analysis:
                ...
                if (studentAnalysisFragment1 == null){
                    studentAnalysisFragment1 = new StudentAnalysisFragment1();
                }
                showFragmentAtPosition1(studentAnalysisFragment1);
                openOrCloseDrawerLayout();
...
//                    fragmentCut(i);
                    if (settingWorkFragment1 != null){
                        if (PWSelectTV.equals(filtrateList.get(0))){
                            settingWorkFragment1.refreshData(true);
                        }else {
                            settingWorkFragment1.refreshData(false);
                        }
                    }
                }
...
//                startActivity(intent);
                if (popSign == 3){
                    if (feedbackFragment1 != null){
                        feedbackFragment1.refreshData(false, startTime, endTime);
                    }
                }else if (popSign == 2){
                    if (teachingReflectionFragment1 != null){
                        teachingReflectionFragment1.refreshData(false, startTime, endTime);
                    }
                }
