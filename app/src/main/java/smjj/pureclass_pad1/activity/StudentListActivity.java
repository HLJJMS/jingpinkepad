...
public class StudentListActivity extends BaseActivity
    ...
    private void findView() {
        ...
        adapter = new CommonAdapter<StudentListBean.TablesBean.TableBean.RowsBean>(context, listData, R.layout.item_scheduling_lv) {
            @Override
            public void convert(ViewHolder holder, StudentListBean.TablesBean.TableBean.RowsBean rowsBean) {
                ...
                holder.setText(R.id.sd_no_tv, rowsBean.getLoginName());
                holder.setText(R.id.sd_schgegin_tv, rowsBean.getUserName());
                holder.setText(R.id.sd_class_type_tv, rowsBean.getSex());
                holder.setText(R.id.sd_subjects_tv, rowsBean.getXueDuan() + rowsBean.getClassYear());
                holder.setText(R.id.sd_grade_tv, rowsBean.getCSdate());
                holder.setText(R.id.sd_class_date_tv, rowsBean.getXueXiaoName());

                if (rowsBean.getSfShortName() != null){
                    holder.setText(R.id.sd_start_date_tv, rowsBean.getSfShortName());
                    if (rowsBean.getCsShortName() != null){
                        holder.setText(R.id.sd_start_date_tv, rowsBean.getSfShortName() + rowsBean.getCsShortName());
                    }
                }else {
                    if (rowsBean.getCsShortName() != null){
                        holder.setText(R.id.sd_start_date_tv, rowsBean.getCsShortName());
                    }else {
                        holder.setText(R.id.sd_start_date_tv, "");

                    }

                }

                holder.getView(R.id.sd_student_list).setVisibility(View.GONE);
