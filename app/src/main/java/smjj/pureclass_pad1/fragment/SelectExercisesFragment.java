...
import smjj.pureclass_pad1.activity.ItemBankActivity;
...
public class SelectExercisesFragment extends Fragment
    ...
    private SelectExercisesActivity activity;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        context = getActivity();
        activity = (SelectExercisesActivity) getActivity();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View contentView = inflater.inflate(R.layout.fragment_select_exercises, container, false);
        ...
        switch (view.getId()){
            case R.id.ll_exercises_cat:
                if (isAddBskList.size() != 0){
                    Intent intent = new Intent(context, ItemBankActivity.class);
...
//            jsonObject.put("Subject", "数学");
    ...
    private void addTestToBsk(final Integer contentId){
        ...
        if (CommonWay.netWorkCheck(context)) { // 在有网络的情况下登入
            ...
            final String jsonCode = jsonObject.toJSONString();
            String MD5Result = MD5.stringMd5(jsonCode + Constants.key);
            String methodName = Constants.AddBasketMN;
            HashMap<String, String> map = new HashMap<>();
            map.put("jsoncode", jsonCode);
            map.put("token", MD5Result);
            activity.showLoading1();
