...
//        fileUrl = "http://ow365.cn/?i=16558&furl=http://erp.iwenxin.net/Lecture/LectureUpLoad/语言学科-古诗词鉴赏/1.鉴赏赏析.pptx";
        fileUrl="http://erp.iwenxin.net/Lecture/LectureUpLoad/1.鉴赏赏析 (Web)/index.html";
        initWebView();
//        getContentUrl();
