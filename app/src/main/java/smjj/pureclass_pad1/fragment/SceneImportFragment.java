 ...
 */
//情境导入碎片
public class SceneImportFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View contentView = inflater.inflate(R.layout.fragment_scene_import, container, false);
...
//        fileUrl = "http://ow365.cn/?i=16558&furl=http://erp.iwenxin.net/Lecture/LectureUpLoad/语言学科-古诗词鉴赏/2.基础训练.pptx";
        fileUrl = "http://erp.iwenxin.net/Lecture/LectureUpLoad/2.基础训练 (Web)/index.html";
        initWebView();
//        getContentUrl();
...
//                                            activity.skipWebView(fileUrl, "1");
                                            initWebView();
