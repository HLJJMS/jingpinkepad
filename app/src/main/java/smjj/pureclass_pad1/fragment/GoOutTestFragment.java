 ...
 */
//出门考发布试卷碎片
public class GoOutTestFragment extends Fragment implements View.OnClickListener{
...
//    private CommonAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View contentView = inflater.inflate(R.layout.fragment_go_out_test, container, false);
    ...
    private void findView(View view){
        ...
        adapter = new ReleaseWorkeAdapter(context, listData, grade, "2");
                        ...
                        if (jsonObject != null) {
                            try {
                                ...
                                if (resultvalue.equals("1") || resultvalue.equals("-1")) {
                                    ...
                                    //校验失败 是指token校验失败
                                    AlertDialogUtil.showAlertDialog(context, "提示", "本节课没有出门考试题");
                                } else {
                                    Gson gson = new Gson();
...
//                                        CommonWay.testSort(listData);
    ...
    //检查出门考试题是否已经发布
    private void checkedReleaseGoOutTest() {
        if (CommonWay.netWorkCheck(context)) { // 在有网络的情况下登入
